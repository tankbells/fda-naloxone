...
public class UserAttributesAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            convertView = layoutInflater.inflate(com.tankbell.naloxone.R.layout.fields_generic, null);
            holder = new Holder();
            holder.label = (TextView) convertView.findViewById(com.tankbell.naloxone.R.id.textViewUserDetailLabel);
            holder.data = (TextView) convertView.findViewById(com.tankbell.naloxone.R.id.editTextUserDetailInput);
            holder.message = (TextView) convertView.findViewById(com.tankbell.naloxone.R.id.textViewUserDetailMessage);
        ...
        if(item.getDataDrawable() != null) {
            if(item.getDataDrawable().equals("checked")) {
                resID = com.tankbell.naloxone.R.drawable.checked;
            }
            else if(item.getDataDrawable().equals("not_checked")) {
                resID = com.tankbell.naloxone.R.drawable.not_checked;
            }
        }
