...
public class UserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.tankbell.naloxone.R.layout.activity_user);
        ...
        mDrawer = (DrawerLayout) findViewById(com.tankbell.naloxone.R.id.user_drawer_layout);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // Do the task
        if(menuItem == com.tankbell.naloxone.R.id.user_update_attribute) {
            //updateAllAttributes();
    ...
    private void getDetails() {
        AppHelper.getPool().getUser().getDetailsInBackground(detailsHandler);
    }
    ...
    private void showAttributes() {
        ...
        attributesListView = (ListView) findViewById(com.tankbell.naloxone.R.id.listViewUserAttributes);
        ...
        attributesListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                TextView data = (TextView) view.findViewById(com.tankbell.naloxone.R.id.editTextUserDetailInput);
