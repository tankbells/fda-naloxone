...
public class AddAttributeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.tankbell.naloxone.R.layout.activity_add_attribute);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        Toolbar toolbar = (Toolbar) findViewById(com.tankbell.naloxone.R.id.toolbar_add_attribute);
        toolbar.setTitle("");
        ...
        TextView main_title = (TextView) findViewById(com.tankbell.naloxone.R.id.add_attr_toolbar_title);
    ...
    void init() {
        attributeTypes = (Spinner) findViewById(com.tankbell.naloxone.R.id.spinnerAttributes);
        attributeData = (EditText) findViewById(com.tankbell.naloxone.R.id.editTextAttrData);
        addAttributeButton = (Button) findViewById(com.tankbell.naloxone.R.id.add_attr_button);
        ...
        attributeData.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    TextView label = (TextView) findViewById(com.tankbell.naloxone.R.id.textViewAttrDataLabel);
                    label.setText(attributeData.getHint());
                    attributeData.setBackground(getDrawable(com.tankbell.naloxone.R.drawable.text_border_selector));
                }
            }

            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                TextView label = (TextView) findViewById(com.tankbell.naloxone.R.id.textViewAttrDataMessage);
                label.setText("");
            }
