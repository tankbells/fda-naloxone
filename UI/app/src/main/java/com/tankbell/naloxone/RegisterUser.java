...
public class RegisterUser extends AppCompatActivity {
    ...
    private void init() {
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                patientName = givenName.getText().toString();
                if (patientName != null) {
                    if (patientName.length() > 0) {
                        userAttributes.addAttribute(AppHelper.getSignUpFieldsC2O().get(givenName.getHint()).toString(), patientName);
                    }
                }
                ...
                if (emailAddress != null) {
                    if (emailAddress.length() > 0) {
                        userAttributes.addAttribute(AppHelper.getSignUpFieldsC2O().get(email.getHint()).toString(), emailAddress);
                    }
                }
                ...
                if (phoneNumber != null) {
                    if (phoneNumber.length() > 0) {
                        userAttributes.addAttribute(AppHelper.getSignUpFieldsC2O().get(phone.getHint()).toString(), phoneNumber);
                    }
                }
    ...
    SignUpHandler signUpHandler = new SignUpHandler() {
        ...
        public void onSuccess(CognitoUser user, boolean signUpConfirmationState,
            ...
            if (signUpConfirmationState) {
                ...
                cache.setUserName(usernameInput);
    ...
    private void confirmSignUp(CognitoUserCodeDeliveryDetails cognitoUserCodeDeliveryDetails) {
        ...
        intent.putExtra("gN",patientName);
    ...
    private class DynamoDBManagerTask extends
        ...
        protected DynamoDBManagerTaskResult doInBackground(
            ...
            String tableStatus = DynamoDBManager.getTableStatusRegisterUser();
            ...
            if (types[0] == DynamoDBManagerType.INSERT_USER) {
                if (tableStatus.equalsIgnoreCase("ACTIVE")) {
                    DynamoDBManager.insertUserDetailsRegister(cache);
                }
            }
